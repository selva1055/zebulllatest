...
(function (definition) {
	 ...
	 * @since 7.2.0 &mdash; Added the <code>fade</code> argument.
	 */
	 ...
	 * @since 7.2.0 &mdash; Replaces {@link CIQ.UI.observe}.
	 */
	 ...
	 * @since 7.2.0 &mdash; Replaces {@link CIQ.UI.unobserve}.
	 */
...
```
	 ...
	 * ```
	 *
	 * Your markerImplementation should include a function called 'showMarkers' which should accept the following parameters:
	 * - type : primary type of marker. In our case: circle, square, etc.
	 * - renderType : a secondary marker type. In our case: none or Performance.
	 *
	 * 'showMarkers' should always remove all markers, before adding the new type requested.
	 *
	 * Example:
```
...
```
	...
	CIQ.UI.Markers.prototype.showMarkers=function(node, type, markerType){
		...
		$(this.menuItemSelector).each(function() {
			if (node.node==this) {
		...
		if(this.implementation) this.implementation.showMarkers(type, markerType);
	};
